<template>
    <div class="table">
        ...
        <section>
            <router-link v-for="item in mywarehouse" :key="item.id" :to="'baosunPage?CODE='+item.warehouseCode">
            ...
            <router-link v-for="item in myStores" :key="item.id" :to="'baosunPage?CODE='+item.storeCode">
                <el-card :body-style="{ padding: '0px' }" class="card">
