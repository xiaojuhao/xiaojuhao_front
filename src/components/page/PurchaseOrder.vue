    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>入库单录入</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <header>
        ...
        <section>
            <router-link v-for="item in mywarehouse" :key="item.id" :to="'purchaseOrderPage?CODE='+item.warehouseCode">
            ...
            <router-link v-for="item in myStores" :key="item.id" :to="'purchaseOrderPage?CODE='+item.storeCode">
                <el-card :body-style="{ padding: '0px' }" class="card">
