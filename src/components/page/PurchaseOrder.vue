<template>
    <div class="table">
        ...
        <section>
            <router-link v-for="item in mywarehouse" :to="'purchaseOrderPage?CODE='+item.warehouseCode">
            ...
            <router-link v-for="item in myStores" :to="'purchaseOrderPage?CODE='+item.storeCode">
                <el-card :body-style="{ padding: '0px' }" class="card">
