<template>
    <div style="display:inline;">
        <el-select v-model="selectedCode" placeholder="选择门店" filterable clearable :filter-method="filterMethod" @keyup.enter.native="enterkey" @change="setValue" @visible-change="visualChange">
